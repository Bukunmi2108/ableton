...
const Body = () => {
  return (
    <div className='w-full mx-auto'>
      ...
      viewport={{ once: true }}
      transition={{ duration: 2 }}
      className='w-full h-[540px] lg:h-[640px] mx-auto relative'>
      ...
      <motion.section 
        ...
        whileInView="visible"
        viewport={{ once: true }}
        transition={{ duration: 3 }}className='w-full h-[540px] lg:h-[640px] mx-auto relative'>
      ...
      <motion.section 
        ...
        whileInView="visible"
        viewport={{ once: true }}
        transition={{ duration: 3 }}className='w-full mx-auto'>
